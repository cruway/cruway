...
| 🔥 | **novel_game** | 月刊アビス — Occult mystery visual novel game | `Flutter` `Dart` `Flame` | 19d ago |
| 🔥 | **devquest** | RPG-style gamified developer task manager | `Flutter` `Flame` `Bonfire` | 2mo ago |
| ⚡ | **japan-loto-predictor** | Lottery prediction engine with statistical analysis | `Python` `AI/ML` | 21d ago |
| ⚡ | **novel-ai-project** | AI-powered novel auto-generation platform | `AI` `Automation` | 3mo ago |
| ⚡ | **study-tool** 🆕 | System Design Master — interview prep toolkit | `TypeScript` | 1d ago |
...
<sub>⏱ Auto-generated from `quests.yml` · last update: 2026-06-07 21:24 UTC</sub>
