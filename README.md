...
[![Backend Skills](https://skillicons.dev/icons?i=java,spring,python,fastapi,go&theme=dark)](https://skillicons.dev)

### 🛡️ Sub Class — Frontend & App
[![Frontend Skills](https://skillicons.dev/icons?i=flutter,dart,ts,react,nextjs&theme=dark)](https://skillicons.dev)

### 🧪 Alchemy — AI & Data
[![AI Skills](https://skillicons.dev/icons?i=pytorch,tensorflow,selenium&theme=dark)](https://skillicons.dev)

### 🏗️ Fortress — Infra & DevOps
[![Infra Skills](https://skillicons.dev/icons?i=docker,githubactions,aws,gcp,linux&theme=dark)](https://skillicons.dev)

### 🔧 Arsenal — Tools & DB
[![Tool Skills](https://skillicons.dev/icons?i=git,gradle,mysql,postgres,redis&theme=dark)](https://skillicons.dev)
...
| ⚡ | **japan-loto-predictor** | Lottery prediction engine with statistical analysis | `Python` `AI/ML` | 29d ago |
| ⚡ | **novel-ai-project** | AI-powered novel auto-generation platform | `AI` `Automation` | 3mo ago |
| ⚡ | **study-tool** 🆕 | System Design Master — interview prep toolkit | `TypeScript` | 3d ago |
| 🛠️ | [**techpulse-blog**](https://github.com/cruway/techpulse-blog) | IT tech trend blog powered by Go + HTMX + n8n | `Go` `HTMX` | 3mo ago |
| 🛠️ | [**workflow-visualizer**](https://github.com/cruway/workflow-visualizer) | Excel-like UI for creating Mermaid diagrams | `TypeScript` `Tauri` | 3mo ago |
| 🛠️ | [**doc-to-markdown-editor**](https://github.com/cruway/doc-to-markdown-editor) | Google Docs → structured Markdown export tool | `TypeScript` | 3mo ago |
| 🎮 | **undead_survive** | Survival hack & slash action game | `Flutter` `Dart` | 4mo ago |

</div>

> 🗝️ *Some quests are hidden in private dungeons...*
<sub>⏱ Auto-generated from `quests.yml` · last update: 2026-06-15 21:50 UTC</sub>
