...
| 🔥 | **novel_game** 🆕 | 月刊アビス — Occult mystery visual novel game | `Flutter` `Dart` `Flame` | 2d ago |
| 🔥 | **devquest** 🆕 | RPG-style gamified developer task manager | `Flutter` `Flame` `Bonfire` | 3d ago |
...
| ⚡ | **study-tool** | System Design Master — interview prep toolkit | `TypeScript` | 12d ago |
...
<sub>⏱ Auto-generated from `quests.yml` · last update: 2026-06-24 21:28 UTC</sub>
